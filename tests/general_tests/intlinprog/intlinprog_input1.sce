...
// Calling intlinprog
[x,f,status,output] = intlinprog(c,intcon,A)

//intlinprog: Unexpected number of input arguments : 3 provided while should be in the set [4 6 8 9]
//at line     152 of function intlinprog called by :  
//[x,f,status,output] = intlinprog(c,intcon,A)
//at line      27 of exec file called by :    
//exec intlinprog_input1.sce
