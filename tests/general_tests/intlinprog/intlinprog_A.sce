...
// Calling intlinprog
[x,f,status,output] = intlinprog(c,intcon,b,b,Aeq,beq,lb,ub)

// !--error 10000 
//intlinprog: The size of inequality constraint is not equal to the number of variables
