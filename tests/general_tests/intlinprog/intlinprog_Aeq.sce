...
// Calling intlinprog
[x,f,status,output] = intlinprog(c,intcon,A,b,beq,beq,lb,ub)


// !--error 10000 
//intlinprog: The size of equality constraint is not equal to the number of variables
//at line     141 of function cbcmatrixintlinprog called by :  
//at line     203 of function intlinprog called by :  
//[x,f,status,output] = intlinprog(c,intcon,[],[],beq,beq,lb,ub)
//at line      27 of exec file called by :    
//exec intlinprog_Aeq.sce
